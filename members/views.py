...
from .form import SignUpForm ,EditProfileForm ,PasswordChangeingForm ,ProfilePageForm
...
class EditProfilePageView(generic.UpdateView):
    ...
    # success_url = reverse_lazy('profile_page',{'pk': super().get('pk')})
...
def password_success(request):
    return render(request ,'registration/password_success')
